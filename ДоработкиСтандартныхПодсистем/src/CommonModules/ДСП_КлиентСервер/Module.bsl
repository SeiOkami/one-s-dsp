...
// Настройка "Расширенные события формы" подсистемы "Варианты отчетов".
// 
// Возвращаемое значение:
//  Булево
Функция Настройка_ВариантыОтчетов_РасширенныеСобытияФормы() Экспорт
	
	НастройкиПодсистемы = НастройкиРасширения().ВариантыОтчетов;
	
	Возврат НастройкиПодсистемы.Использовать 
		И НастройкиПодсистемы.РасширенныеСобытияФормы;
...
// * ВариантыОтчетов - см. НовыйНастройкиПодсистемыВариантыОтчетов
...
Функция НовыйНастройкиРасширения() Экспорт
	...
	Результат.Вставить("ВариантыОтчетов", НовыйНастройкиПодсистемыВариантыОтчетов());
...
// Конструктор объекта Настройки подсистемы "Варианты отчетов".
// 
// Возвращаемое значение:
//  Структура:
// * Использовать - Булево - Использовать ли доработки подсистемы
// * РасширенныеСобытияФормы - Булево - Разрешать ли отчету переопределять клиентские события в своей форме
Функция НовыйНастройкиПодсистемыВариантыОтчетов() Экспорт
	
	Результат = Новый Структура;
	Результат.Вставить("Использовать", Ложь);
	Результат.Вставить("РасширенныеСобытияФормы", Ложь);
